...
double chi2_eta(double *theta, int chain_ind)
{
  ...
  double z[3] = {0.29,0.415,0.6};

  double eta_fid[3] = {0.097609751107826,0.097898582729410,0.098162195438782};
  double err_eta[3] = {6.70043430070261e-03,5.48009250386955e-03,1.09688422334509e-02};
  double R_fid = 22.0;
  double n_fid = 2.1;
  ...
  create_class_ini(theta,3,z,chain_ind);
